...
class edx(object):
    ...
    def setGrade(self, grade, course=""):
        ...
        for n in self.myCourses:
            if n.courseName == course.courseName:
                n.setGrade(grade)
    ...
    def setPset(self, pset, score, course=""):
        ...
        """
        #technically, I ought to change the default here as well and return "None" when default is unchanged.
        if course == "":
            return "None"
        course = courseInfo(course)
        for n in self.myCourses:
