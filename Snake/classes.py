...
class SnakeGame:
    ...
    def addFood(self):
        ...
        """I'm thinking of altering this in order to make the food only spawn in squares not occupied by the snake."""
    ...
    def input(self, events):
        ...
        return True
        """Is there some way to add in support for the keyboard directions keys in addition to W,A,S,D?"""
        """Is there some way to make the controls more responsive? Make the snake react to commands quicker and more consistently? A higher tick-rate for the checks for commands?"""
        """Perhaps a buffer for commands (that is constantly overwritten by new inputs?)"""
